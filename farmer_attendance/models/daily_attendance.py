...
class DailyAttendance(models.Model):
    ...
    village_ids = fields.Many2many('village.master','attendance_id','village_id','attendance_village_farmers_rel','Villages')
    ...
    total = fields.Float(string='Total (KG)',compute="_get_total_grade")
...
class DailyAttendanceLine(models.Model):
    ...
    total = fields.Float(string='Total (KG)', compute="_get_lines_total")
